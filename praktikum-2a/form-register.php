  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" placeholder="*0110124237" type="text" class="form-control" required="required" pattern="[0-9]{10}" title="0110124237">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama_lengkap" name="nama_lengkap" placeholder="*Rifqi Huzaifah" type="text" class="form-control" required="required" minlengt="3" maxlenght="50">
      </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="email" name="email" placeholder="*contoh@gmail.com" type="email" class="form-control">
      </div>
    </div>
  </div> 
  <div class="form-group row">
